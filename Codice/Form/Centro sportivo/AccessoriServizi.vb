' Nome form:            frmAccessoriServizi
' Autore:               Luigi Montana, Montana Software
' Data creazione:       31/10/2012
' Data ultima modifica: 31/10/2012
' Descrizione:          Anagrafica Accessori e Servizi.
...
Public Class frmAccessoriServizi
...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmAccessoriServizi))
      ...
      Me.txtDescrizione.Location = New System.Drawing.Point(144, 64)
      Me.txtDescrizione.MaxLength = 0
      Me.txtDescrizione.Name = "txtDescrizione"
      Me.txtDescrizione.RightToLeft = System.Windows.Forms.RightToLeft.No
      Me.txtDescrizione.Size = New System.Drawing.Size(216, 20)
      ...
      Me.Label21.Text = "Escludi dalla gestione:"
      '
      'Label6
      '
      ...
      Me.txtNumero.Location = New System.Drawing.Point(144, 32)
      ...
      Me.Name = "frmAccessoriServizi"
      Me.ShowInTaskbar = False
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Accessori e Servizi"
...
#End Region
      ...
      Select Case e.Button.Tag
         Case "Salva"
            ...
            If SalvaDati() = True Then
               ...
               If IsNothing(g_frmAccessoriServizi) = False Then
                  ' Aggiorna la griglia dati.
                  g_frmAccessoriServizi.AggiornaDati()
               End If
               ...
               g_frmMain.RegistraOperazione(TipoOperazione.Salva, strDescrizione, MODULO_ANAGRAFICA_ACCESSORI_SERVIZI)
            End If
         ...
         Case "Annulla"
            ...
            ' Registra loperazione effettuata dall'operatore identificato.
            g_frmMain.RegistraOperazione(TipoOperazione.Annulla, String.Empty, MODULO_ANAGRAFICA_ACCESSORI_SERVIZI)
      End Select
   End Sub

   Private Sub frmAccessoriServizi_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
      If Me.Tag <> "0" Then
         ' Registra loperazione effettuata dall'operatore identificato.
         g_frmMain.RegistraOperazione(TipoOperazione.Annulla, String.Empty, MODULO_ANAGRAFICA_ACCESSORI_SERVIZI)
      End If
   ...
   Private Sub frmAccessoriServizi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Try

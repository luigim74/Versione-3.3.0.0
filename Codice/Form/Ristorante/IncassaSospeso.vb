...
#Region " Codice generato da Progettazione Windows Form "
   ...
   Private components As System.ComponentModel.IContainer
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtCitt‡.Enabled = False
        Me.txtCitt‡.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txtCitt‡.ForeColor = System.Drawing.SystemColors.WindowText
        Me.txtCitt‡.Location = New System.Drawing.Point(184, 104)
        Me.txtCitt‡.MaxLength = 100
        Me.txtCitt‡.Name = "txtCitt‡"
        Me.txtCitt‡.RightToLeft = System.Windows.Forms.RightToLeft.No
        Me.txtCitt‡.Size = New System.Drawing.Size(176, 20)
        ...
        Try
            ...
            Do While dr.Read
                ...
                Else
                    txtCap.Text = ""
                End If
                If IsDBNull(dr.Item("Citt‡")) = False Then
                    txtCitt‡.Text = dr.Item("Citt‡")
                Else
                    txtCitt‡.Text = ""
                End If
                ...
                If IsDBNull(dr.Item("CodFisc")) = False Then
                    txtCodiceFiscale.Text = dr.Item("CodFisc")
                Else
   ...
   Private Function LeggiNumeroMax(ByVal tabella As String, ByVal tipoDoc As String) As Integer
    ...
    Private Sub cmdStampa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStampa.Click
        Try
            ...
            ' Registra loperazione effettuata dall'operatore identificato.
            Dim strDescrizione As String = " (" & Doc.Tipo & " n. " & Doc.Numero & " del " & Doc.Data & " - Ä " & Doc.TotDoc & ")"

...
#Region " Windows Form Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.cmdOk.Location = New System.Drawing.Point(199, 156)
      Me.cmdOk.Name = "cmdOk"
      ...
      Me.cmdAnnulla.Location = New System.Drawing.Point(287, 156)
...
#End Region
      ...
      Try
         With AIngredienti
            ...
            If IsNumeric(txtQuantit‡.Text) Then
               .Quantit‡ = Convert.ToDouble(CFormatta.FormattaQuantit‡(txtQuantit‡.Text, 3))
            Else
               .Quantit‡ = 0
            End If
            ...
            If Me.Tag.ToString <> "" Then
               Return .ModificaDati(NOME_TABELLA, Me.Tag.ToString)
            Else
   ...
   Private Function CalcolaCosto(ByVal prezzoAcquisto As String, ByVal quantit‡ As String) As String
      Try
         If prezzoAcquisto = String.Empty Or quantit‡ = String.Empty Then
            Return VALORE_ZERO
         Else
            Dim prezzo As Decimal = Convert.ToDecimal(prezzoAcquisto)
            Dim qt‡ As Decimal = Convert.ToDecimal(quantit‡)
            Dim costo As Decimal = prezzo * qt‡

            Return CFormatta.FormattaEuro(costo)
         End If
      ...
      Try
         ...
         If Me.Tag.ToString <> "" Then
            With AIngredienti
               ...
               ' Assegna i dati dei campi della classe alle caselle di testo.
               txtCodice.Text = .Id.ToString
               cmbDescrizione.Text = .Descrizione
               txtUM.Text = .Unit‡Misura
               txtQuantit‡.Text = CFormatta.FormattaQuantit‡(.Quantit‡, 3)
               txtCosto.Text = CFormatta.FormattaEuro(.Costo)
            End With
         Else
            txtQuantit‡.Text = VALORE_ZERO
   ...
   Private Sub txtQuantit‡_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtQuantit‡.LostFocus
      Try
         If IsNumeric(txtQuantit‡.Text) Then
            txtQuantit‡.Text = CFormatta.FormattaQuantit‡(txtQuantit‡.Text, 3)

            txtCosto.Text = CalcolaCosto(AArticoli.PrezzoAcquisto, txtQuantit‡.Text)
         End If
   ...
   Private Sub cmbDescrizione_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbDescrizione.SelectedIndexChanged
      Try
         With AArticoli
            ' Visualizza i dati nei rispettivi campi.
            .LeggiDati("Articoli", cmbId_Art.Items.Item(cmbDescrizione.Items.IndexOf(cmbDescrizione.Text)).ToString)

            ' Assegna i dati dei campi della classe alle caselle di testo.
            txtUM.Text = .Unit‡Misura
            txtCosto.Text = CalcolaCosto(.PrezzoAcquisto, txtQuantit‡.Text)
         End With

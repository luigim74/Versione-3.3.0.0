...
#Region "Dichiarazioni"
   ...
   Dim TAB_PREN As String = "Prenotazioni"
   ...
   Friend WithEvents eui_cmdNuova As Elegant.Ui.Button
...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.eui_cmdNuova = New Elegant.Ui.Button()
      ...
      Me.DataGrid1.Size = New System.Drawing.Size(569, 464)
      ...
      Me.Panel1.Size = New System.Drawing.Size(277, 464)
      ...
      Me.mcCalendario.Location = New System.Drawing.Point(29, 8)
      ...
      Me.eui_cmdNuova.Text = "&&Nuova"
      '
      'frmElencoPren
      '
      Me.AcceptButton = Me.eui_cmdNuova
...
#End Region
   ...
   Public Sub EliminaDati(ByVal tabella As String, ByVal id As Integer)
      Try
         ...
         ' Registra l'operazione.
         strDescrizione = " (" & DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 1) &
                          " - Per " & DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 3) &
                          " il " & DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 0) &
                          " alle " & DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 4) &
   ...
   Private Sub eui_cmdNuova_Click(sender As Object, e As EventArgs) Handles eui_cmdNuova.Click
      ' Riproduce un effetto sonoro.

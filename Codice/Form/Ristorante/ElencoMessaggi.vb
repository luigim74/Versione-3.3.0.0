...
#End Region
   ...
   Private Sub ElencoMessaggi_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
      Try
         ...
         ' La finestra è richiamata anche dal punto cassa.

      ...
      Select Case e.Button.Tag
         Case "Salva"
            ...
            If persone > posti Then
               risposta = MsgBox("Il tavolo selezionato è troppo piccolo per il numero degli occupanti!" & vbCrLf & _
            ...
            If persone < posti Then
               risposta = MsgBox("Il tavolo selezionato è troppo grande per il numero degli occupanti!" & vbCrLf & _
                                 "Si desidera continuare comunque?.", MsgBoxStyle.YesNo + MsgBoxStyle.Question, NOME_PRODOTTO)
               If risposta = vbNo Then
                  Exit Sub
               End If
